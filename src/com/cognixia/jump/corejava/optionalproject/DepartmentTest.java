...
class DepartmentTest {
    ...
    Employee employee0 = new Employee("name0", "tx", "developer", 100.000, date, Employee.EmployeeType.FULL_TIME, Employee.PayPeriod.MONTHLY);
    ...
    void getListEmp() throws AddException {
        ...
        Employee employee2 = new Employee("name2", "ca", "tester", 60.000, date, Employee.EmployeeType.FULL_TIME, Employee.PayPeriod.WEEKLY);
        Employee employee3 = new Employee("name3", "nm", "developer", 70.000, date, Employee.EmployeeType.FULL_TIME, Employee.PayPeriod.BI_WEEKLY);
